...
def gerar_boxplot_unico(dataset, nome_algoritmo, metrica):
    ...
    # lendo os arquivos 
    data = []
    data.append(pd.read_excel(io='arquivos_lista01/'+dataset+'-pct-0.5.xls', sheet_name=nome_algoritmo)[metrica])
    data.append(pd.read_excel(io='arquivos_lista01/'+dataset+'-pct-0.6.xls', sheet_name=nome_algoritmo)[metrica])
    data.append(pd.read_excel(io='arquivos_lista01/'+dataset+'-pct-0.7.xls', sheet_name=nome_algoritmo)[metrica])
    data.append(pd.read_excel(io='arquivos_lista01/'+dataset+'-pct-0.8.xls', sheet_name=nome_algoritmo)[metrica])
    data.append(pd.read_excel(io='arquivos_lista01/'+dataset+'-pct-0.9.xls', sheet_name=nome_algoritmo)[metrica])
    data.append(pd.read_excel(io='arquivos_lista01/'+dataset+'-pct-1.xls', sheet_name=nome_algoritmo)[metrica])
...
def gerar_boxplot_metrica_geral(dataset, metrica):
    ...
    for i in porcentagens:
        quadro = (i)
        alg1 = pd.read_excel(io='arquivos_lista01/'+dataset+'-pct-'+i+'.xls', sheet_name='bag_dt')[metrica]
        alg2 = pd.read_excel(io='arquivos_lista01/'+dataset+'-pct-'+i+'.xls', sheet_name='rs_dt')[metrica]
        alg3 = pd.read_excel(io='arquivos_lista01/'+dataset+'-pct-'+i+'.xls', sheet_name='bag_p')[metrica]
        alg4 = pd.read_excel(io='arquivos_lista01/'+dataset+'-pct-'+i+'.xls', sheet_name='rs_p')[metrica]
...
def gerar_boxplot_metrica_bgrs(dataset, metrica):
    ...
    for i in porcentagens:
        quadro = (i)
        alg1 = np.asarray(pd.read_excel(io='arquivos_lista01/'+dataset+'-pct-'+i+'.xls', sheet_name='bag_dt')[metrica])
        alg2 = np.asarray(pd.read_excel(io='arquivos_lista01/'+dataset+'-pct-'+i+'.xls', sheet_name='bag_p')[metrica])
        alg3 = np.asarray(pd.read_excel(io='arquivos_lista01/'+dataset+'-pct-'+i+'.xls', sheet_name='rs_dt')[metrica])
        alg4 = np.asarray(pd.read_excel(io='arquivos_lista01/'+dataset+'-pct-'+i+'.xls', sheet_name='rs_p')[metrica])
...
def gerar_boxplot_metrica_bgrs_twodata(metrica):
    ...
    for i in porcentagens:
        ...
        alg1 = np.asarray(pd.read_excel(io='arquivos_lista01/kc1-pct-'+i+'.xls', sheet_name='bag_dt')[metrica])
        alg2 = np.asarray(pd.read_excel(io='arquivos_lista01/kc1-pct-'+i+'.xls', sheet_name='bag_p')[metrica])
        alg3 = np.asarray(pd.read_excel(io='arquivos_lista01/kc1-pct-'+i+'.xls', sheet_name='rs_dt')[metrica])
        alg4 = np.asarray(pd.read_excel(io='arquivos_lista01/kc1-pct-'+i+'.xls', sheet_name='rs_p')[metrica])
        
        alg5 = np.asarray(pd.read_excel(io='arquivos_lista01/kc2-pct-'+i+'.xls', sheet_name='bag_dt')[metrica])
        alg6 = np.asarray(pd.read_excel(io='arquivos_lista01/kc2-pct-'+i+'.xls', sheet_name='bag_p')[metrica])
        alg7 = np.asarray(pd.read_excel(io='arquivos_lista01/kc2-pct-'+i+'.xls', sheet_name='rs_dt')[metrica])
        alg8 = np.asarray(pd.read_excel(io='arquivos_lista01/kc2-pct-'+i+'.xls', sheet_name='rs_p')[metrica])
